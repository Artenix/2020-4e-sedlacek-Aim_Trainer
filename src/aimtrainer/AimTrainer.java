...
public class AimTrainer extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        tRandom.setFont(new Font("Technic", 25));
        ...
        tCustom.setFont(new Font("Technic", 25));
        ...
        spCustom.setOnMouseClicked((MouseEvent event) -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLcustomMap1.fxml"));
                ...
                Logger.getLogger(AimTrainer.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        //pridani objektu do StackPanu a nastaveni pozice
        ...
        tExit.setFont(new Font("Technic", 25));
